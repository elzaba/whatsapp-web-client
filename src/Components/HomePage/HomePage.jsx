...
import { BsThreeDotsVertical, BsFilter, BsMicFill, BsEmojiSmile } from "react-icons/bs";
        ...
        {!currentChat && (
          <div className="w-[70%] flex flex-col items-center justify-center">
            <div className="max-w-[70%] text-center">
              <img
                src="https://github.com/elzaba/whatsapp-web-client/blob/main/src/whatsapp_multi_device_support.png?raw=true"
                alt=""
              />
